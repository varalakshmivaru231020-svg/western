...
<div style="max-width: 600px;">
    ...
    <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" style="background: white; padding: 30px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        @csrf
        ...
        <div style="margin-bottom: 20px;">
            ...
            <small style="color: #888;">Accepted formats: PNG, JPG, JPEG, GIF, SVG. Max size: 2MB.</small>
        </div>
